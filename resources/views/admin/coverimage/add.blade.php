	...
	<div class="container">
		...
		<div class="row">
		    ...
		    <div class="col-md-8 col-md-offset-2">
		        ...
		        <form class="form-horizontal" role="form" action="{{route('coverimage.store')}}" method = "POST" enctype="multipart/form-data">
